...
## 🚀 Overview
Background noise often degrades the quality of voice communication. This project demonstrates a pipeline to analyze the spectral characteristics of a noisy signal and design a custom filter to isolate and enhance the human voice.

## 🛠 Key Features
- **Signal Analysis:** Time-domain and Frequency-domain (FFT) analysis to identify noise profiles.
- **Filter Design:** Implementation of an IIR filter.
